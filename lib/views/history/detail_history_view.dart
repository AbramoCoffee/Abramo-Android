    ...
    return Scaffold(
      ...
      body: Obx(() =>
          ...
          Padding(
            ...
            child: listOrderItemModel.isEmpty
                ? Center(
                ...
                : SingleChildScrollView(
                    child: listOrderItemModel.isNotEmpty
                        ? Column(
                            children: listOrderItemModel
                              ...
                              IconButtonComponent(
                                ...
                                onPressed: () async {
                                  ...
                                  if ((await printer.isConnected)!) {
                                    ...
                                    printer.printNewLine();
                                    for (var orderItem in listOrderItemModel) {
                                      printer.printCustom(
              ...
              : Column(
                  children: [
                    userRole == "kitchen"
                        ? ElevatedButton(
                            onPressed: () async {
                              var res = await ordersController
                                  .editOrders(ordersModel!);
                                  ...
                                  printer.printCustom(
                                      "${orderItem.qty!} x " +
                                          RupiahUtils.beRupiah(
                                              orderItem.price!) +
                                          "         " +
                                          RupiahUtils.beRupiah(orderItem.qty! *
                                              orderItem.price!),
                                      1,
                                      0);
                                }
